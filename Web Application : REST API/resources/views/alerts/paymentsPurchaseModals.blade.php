    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="card">
                ...
                <div class="card-body">
                    <form method="post"
                        action="{{ route('purchase.transaction.store', $purchase) }}" autocomplete="off">
                        @csrf
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <form action="{{ route('purchase.transaction.destroy', [$purchase,$transaction]) }}" method="post" class="d-inline">
                                        @csrf
                                        @method('delete')
