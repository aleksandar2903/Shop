...
class MethodController extends Controller
{
    ...
    public function store(Request $request, PaymentMethod $method)
    {
        ...
        return redirect()
            ->route('methods.index')
            ->withStatus(__('Payment method created successfully.'));
    }
    ...
    public function update(Request $request, PaymentMethod $method)
    {
        ...
        return redirect()
            ->route('methods.index')
            ->withStatus(__('Payment method updated successfully.'));
    }
    ...
    public function destroy(PaymentMethod $method)
    {
        ...
        return back()->withStatus(__('Payment method removed successfully.'));
    }
}
